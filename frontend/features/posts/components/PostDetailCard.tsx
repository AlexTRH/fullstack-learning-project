  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center gap-3 pb-2">
        ...
        >
          <div className="flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border bg-muted text-base font-medium text-muted-foreground">
            {post.author.avatar ? (
